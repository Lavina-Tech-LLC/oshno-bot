...
var ConstMessages = Languages{
	Tajik: Messages{
		...
		EnterTariffSelectionOshnoService: fmt.Sprintf("Тарифро интихоб кунед\n1. %s\n2. %s\n3. %s\n4. %s\n5. %s\n6. %s\n7. %s\n8. %s\n9. %s\n10. %s\n", OshnoPlansToj[PlanOne], OshnoPlansToj[PlanTwo], OshnoPlansToj[PlanThree], OshnoPlansToj[PlanFour], OshnoPlansToj[PlanFive], OshnoPlans[PlanSix], OshnoPlans[PlanSeven], OshnoPlans[PlanEight], OshnoPlans[PlanNine], OshnoPlans[PlanTen]),
		...
		PlanTariffLimitOshno:             fmt.Sprintf("Тарифро интихоб кунед\n1. %s\n2. %s\n3. %s\n4. %s\n5. %s\n6. %s\n", OshnoPlansToj[PlanOne], OshnoPlansToj[PlanTwo], OshnoPlansToj[PlanThree], OshnoPlansToj[PlanFour], OshnoPlansToj[PlanFive], OshnoPlansToj[PlanSix]),
		PlanTariffLimitTojNet:            fmt.Sprintf("Тарифро интихоб кунед\n1. %s\n2. %s\n3. %s\n4. %s\n5. %s\n6. %s\n", TojNetPlansToj[PlanOne], TojNetPlansToj[PlanTwo], TojNetPlansToj[PlanThree], TojNetPlansToj[PlanFour], TojNetPlansToj[PlanFive], TojNetPlansToj[PlanSix]),
		PlanTariffUnlimitOshno:           fmt.Sprintf("Тарифро интихоб кунед\n1. %s\n2. %s\n3. %s\n4. %s\n", OshnoPlansToj[PlanSeven], OshnoPlansToj[PlanEight], OshnoPlansToj[PlanNine], OshnoPlansToj[PlanTen]),
		PlanTariffUnlimitTojNet:          fmt.Sprintf("Тарифро интихоб кунед\n1. %s\n2. %s\n3. %s\n4. %s\n5. %s\n6. %s\n7. %s\n", TojNetPlansToj[PlanSeven], TojNetPlansToj[PlanEight], TojNetPlansToj[PlanNine], TojNetPlansToj[PlanTen], TojNetPlansToj[PlanEleventh], TojNetPlansToj[PlanTwelfth], TojNetPlansToj[PlanThirteenth]),
